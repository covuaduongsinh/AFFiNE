...
export const PIECE_SETS_METADATA: Record<ChessPieceSet, PieceSetMetadata> = {
  ...
  diagram: {
    id: 'diagram',
    name: 'Sách cờ (Chess Diagram B&W)',
    author: 'FIDE / Informant Publication Standard',
    license: 'MIT',
    description:
      'Classic black & white publication diagram style for chess training books & manuals',
  },
  kosal: {
    id: 'kosal',
...
export const PIECE_SETS: Record<ChessPieceSet, Record<string, string[]>> = {
  // 1. Staunton Classic (Cburnett Tournament Standard - MIT / CC0 / CC-BY)
  staunton: {
    p: [
    ...
    n: [
      'M22 10C32.5 11 38.5 18 38 39H15C15 30 25 32.5 23 18',
      'M24 18c.38 2.91-5.55 7.37-8 9-3 2-2.82 4.34-5 4-1.04-.94 1.41-3.04 0-3 0 0 1.19 1.23 0 2 0 0-3 1-3-4 0-2 6-12 6-12s1.89-1.9 2-3.5c-.73-.99-.5-2-.5-3 1-1 3 2.5 3 2.5l2 0s.78-1.99 2.5-3c1 0 1 3 1 3',
      'M9.5 25.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z',
      'M15 15.5a.5 1.5 0 1 1-1 0 .5 1.5 0 0 1 1 0z',
    ],
    b: [
      ...
      'M25 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z',
      'M17.5 26h10M15 30h15m-7.5-14.5v5M20 18h5',
    ],
    q: [
      'M8 12a2 2 0 1 1-4 0 2 2 0 0 1 4 0zM24.5 7.5a2 2 0 1 1-4 0 2 2 0 0 1 4 0zM41 12a2 2 0 1 1-4 0 2 2 0 0 1 4 0zM16 8.5a2 2 0 1 1-4 0 2 2 0 0 1 4 0zM33 9a2 2 0 1 1-4 0 2 2 0 0 1 4 0z',
      ...
      'M11.5 30c3.5-1 18.5-1 22 0M12 33.5c6-1 15-1 21 0',
    ],
    k: [
  ...
  // 7. Chess Diagram B&W (FIDE / Informant Publication Standard - MIT)
  diagram: {
    p: [
      'M22.5 9c-2.21 0-4 1.79-4 4 0 .89.29 1.71.78 2.38C17.33 16.5 16 18.59 16 21c0 2.03.94 3.84 2.41 5.03-3 1.06-7.41 5.55-7.41 13.47h23c0-7.92-4.41-12.41-7.41-13.47 1.47-1.19 2.41-3 2.41-5.03 0-2.41-1.33-4.5-3.28-5.62.49-.67.78-1.49.78-2.38 0-2.21-1.79-4-4-4z',
    ],
    ...
    n: [
      ...
      'M9.5 25.5a.5.5 0 1 1-1 0 .5.5 0 1 1 1 0z',
      'M15 15.5a.5.5 0 1 1-1 0 .5.5 0 1 1 1 0z',
    ],
    b: [
      'M9 36c3.39-.97 10.11.43 13.5-2 3.39 2.43 10.11 1.03 13.5 2 0 0 1.65.54 3 2-.68.97-1.65.99-3 .5-3.39-.97-10.11.46-13.5-1-3.39 1.46-10.11.03-13.5 1-1.354.49-2.323.47-3-.5 1.354-1.94 3-2 3-2z',
      'M15 32c2.5 2.5 12.5 2.5 15 0 .5-1.5 0-2 0-2 0-2.5-2.5-4-2.5-4 5.5-1.5 6-11.5-5-15.5-11 4-10.5 14-5 15.5 0 0-2.5 1.5-2.5 4 0 0-.5.5 0 2z',
    ...
    q: [
      ...
      'M9 26c0 2 1.5 2 2.5 4 1 1.5 1 1 .5 3.5-1.5 1-1.5 2.5-1.5 2.5-1.5 1.5.5 2.5.5 2.5 6.5 1 16.5 1 23 0 0 0 2-1 .5-2.5 0 0 0-1.5-1.5-2.5-.5-2.5-.5-2 .5-3.5 1-2 2.5-2 2.5-4-8.5-1.5-18.5-1.5-27 0z',
      'M11.5 30c3.5-1 18.5-1 22 0M12 33.5c6-1 15-1 21 0',
      'M6 12a2 2 0 1 1-4 0 2 2 0 1 1 4 0z',
      'M20.5 8a2 2 0 1 1-4 0 2 2 0 1 1 4 0z',
      'M28.5 8a2 2 0 1 1-4 0 2 2 0 1 1 4 0z',
      'M43 12a2 2 0 1 1-4 0 2 2 0 1 1 4 0z',
      'M14.5 9a1.5 1.5 0 1 1-3 0 1.5 1.5 0 1 1 3 0z',
      'M33.5 9a1.5 1.5 0 1 1-3 0 1.5 1.5 0 1 1 3 0z',
    ],
    k: [
      'M22.5 11.63V6M20 8h5',
      'M22.5 25s4.5-7.5 3-10.5c0 0-1-2.5-3-2.5s-3 2.5-3 2.5c-1.5 3 3 10.5 3 10.5',
      'M11.5 37c5.5 3.5 15.5 3.5 21 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16 4V27v-3.5c-3.5-7.5-13-10.5-16-4-3 6 5 10 6 10.5v7z',
      'M11.5 30c5.5-3 15.5-3 21 0M11.5 33.5c5.5-3 15.5-3 21 0M11.5 37c5.5-3 15.5-3 21 0',
    ],
  },
};
